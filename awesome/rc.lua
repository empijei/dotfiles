...
awful.key({ modkey,    }, "F3", function () awful.spawn("bash -c \"$HOME/bin/kbd_backlight2.sh DOWN\"", false) end,{description = "Decrease keyboard backlight", group = "system"}),
awful.key({ modkey,    }, "F4", function () awful.spawn("bash -c \"$HOME/bin/kbd_backlight2.sh UP\"", false) end,{description = "Increase keyboard backlight", group = "system"}),
